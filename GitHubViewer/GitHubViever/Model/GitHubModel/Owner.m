...
static NSString *const kOwnerId = @"id";
static NSString *const kOwnerOrganizationsUrl = @"organizations_url";
static NSString *const kOwnerReceivedEventsUrl = @"received_events_url";
static NSString *const kOwnerFollowingUrl = @"following_url";
static NSString *const kOwnerLogin = @"login";
static NSString *const kOwnerSubscriptionsUrl = @"subscriptions_url";
static NSString *const kOwnerAvatarUrl = @"avatar_url";
static NSString *const kOwnerUrl = @"url";
static NSString *const kOwnerType = @"type";
static NSString *const kOwnerReposUrl = @"repos_url";
static NSString *const kOwnerHtmlUrl = @"html_url";
static NSString *const kOwnerEventsUrl = @"events_url";
static NSString *const kOwnerSiteAdmin = @"site_admin";
static NSString *const kOwnerStarredUrl = @"starred_url";
static NSString *const kOwnerGistsUrl = @"gists_url";
static NSString *const kOwnerGravatarId = @"gravatar_id";
static NSString *const kOwnerFollowersUrl = @"followers_url";
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:@(self.ownerIdentifier) forKey:kOwnerId];
    ...
    [mutableDict setValue:@(self.siteAdmin) forKey:kOwnerSiteAdmin];
...
{
    Owner *copy = [[[self class] alloc] init];
